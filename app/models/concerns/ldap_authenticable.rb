...
module LdapAuthenticable
  ...
  class_methods do
    ...
    def ldap_get_user(attributes = {})
      ...
      if resource.blank?
        resource = new(email: attributes[Devise.ldap_mail.to_sym].first, agreement: true, account_attributes: { username: attributes[Devise.ldap_uid.to_sym].first }, admin: false, external: true, confirmed_at: Time.now.utc)
        resource.save!
      end
